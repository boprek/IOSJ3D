...
const Keyboard = {
    ...
    removeKeyboard() {
        const existingKeyboard = document.getElementById("keyboard_keys");
        if (existingKeyboard) {
        ...
        keyLayout.forEach(key => {
            ...
            switch (key) {
                ...
                case "enter":
                    ...
                    keyElement.addEventListener("click", () => {
                        // Solo ejecutar si AdminUI existe (modo antiguo)
                        if (window.AdminUI &&
                            typeof window.AdminUI.ValSearchUI === "function" &&
                            typeof window.AdminUI.showUI === "function") {
                            window.AdminUI.ValSearchUI();
                            window.AdminUI.showUI();
                        }
