var ip_server = "localhost:8192";
// Disable background polling to avoid constant requests
...
async function OpenDashboard(event){
	...
	await new Promise(r => setTimeout(r, 100));
	if(!DISABLE_POLLING){ SendRequestDas('{"info":"GetStatus"}'); }
